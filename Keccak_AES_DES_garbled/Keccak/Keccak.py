...
class Keccak:
    ...
    def Keccak(self,M,r=1024,c=576,n=1024,verbose=False):
        ...
        return Z[:2*n//8]
def build_message_pair(data):
  hex_data = data.encode('hex')
  size = len(hex_data) * 4
  return (size, hex_data)

##########################################################################
data = '4d7044b24d374ba15fe75ee664d76ded054ba977bd101f69d57f16fe2fffcf07145f6d73158747bd32516d3b499ccd25a1e206df3b21d468966d89014e505cd8ab7ad7fb5d3acf'
myKeccak=Keccak(1600)

def sha3_224(data):
    Msg = build_message_pair(data)
    return myKeccak.Keccak(Msg,1152,448,224,False)
def sha3_256(data):
    Msg = build_message_pair(data)
    return myKeccak.Keccak(Msg,1088,512,256,False)
def sha3_384(data):
    Msg = build_message_pair(data)
    return myKeccak.Keccak(Msg,832,768,384,False)
def sha3_512(data):
    Msg = build_message_pair(data)
    return myKeccak.Keccak(Msg,576,1024,512,False)
def shake128(data, d):
    Msg = build_message_pair(data)
   #msg is a hexadecimal string, 
    #size is the length of msg in bits
   # r = 1344, c = 256, b = r+c = 1600
    return myKeccak.Keccak(Msg, 1344, 256, d, False)
print(sha3_224(''))
#print(sha3_256(data))
#print(sha3_384(data))
#print(sha3_512(data))
print(shake128('abc', 256))
